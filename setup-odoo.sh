...
# Docker - Installation manuelle pour éviter les packages inexistants
log "Installation Docker..."

# Méthode manuelle plus fiable que get.docker.com
apt update
...
# Installer Docker sans packages problématiques
apt update
...
# Vérifier Docker
docker --version || {
    log "ERREUR: Docker non installé"
    exit 1
}
